...
>(({ asChild = false, isActive = false, variant = "default", size = "default", tooltip, className, ...props }, ref) => {
    ...
    return (
        <Tooltip side="right" align="center" open={state !== "collapsed" || isMobile} {...tooltip}>
            {button}
        </Tooltip>
    );
});
...
>(({ className, showIcon = false, ...props }, ref) => {
    ...
    return (
        <div ref={ref} data-sidebar="menu-skeleton" className={cn(" h-8 flex gap-2 px-2 items-center", className)} {...props}>
