...
const remixFastify = async (fastify, options = {}) => {
    const { buildDirectory = "build", clientDirectory = "client", serverDirectory = "server", serverBuildFile = "index.js", mode = process.env.NODE_ENV || "development", fastifyStaticOptions = {}, viteOptions = {}, } = options;
    let viteDevServer;
    if (mode === "development") {
