...
program.description("Install").action((options) => {
    ...
    try {
        ...
        console.log("");
        console.log(chalk.bgGray(chalk.bold("MongoCarbon:"), "If you want to create a new admin user, Please run the command below"));
        console.log(chalk.bgGray(chalk.bold("MongoCarbon:"), "node console/user.js user --create --username USERNAME --password YOUR_PASSWORD"));
        console.log("");
        console.log(chalk.bgGreen(chalk.bold("MongoCarbon:"), "Installation complete"));
        console.log("");
    } catch (err) {
